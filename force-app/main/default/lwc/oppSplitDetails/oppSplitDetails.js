...
export default class OppSplitDetails extends LightningElement {
    ...
    inputChangeHandler(event){
        ...
        obj.amountChoosed = parseFloat(((obj.UnitPrice/obj.Quantity)*obj.quantityChoosed).toFixed(1))
        obj.remainingAmount = parseFloat((obj.UnitPrice - obj.amountChoosed).toFixed(1));
        prodList[index] = obj;
