...
import getProjectRecord from '@salesforce/apex/ProjectHanlder.getRecord'
//import getRecordDetails from '@salesforce/apex/ProjectHanlder.getRecordDetails'
...
export default class CreateOpportunity extends NavigationMixin(LightningElement) {
    ...
    openCreateRecordForm(){
        ...
        let defaultValues = encodeDefaultFieldValues({
            Parent_Project__c: this.projectRecord.Id,
